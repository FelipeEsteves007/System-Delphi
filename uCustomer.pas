...
begin
  ...
  // Document
  if (Trim(JustNumbers(dbeDocument.Text)) = '') then
  begin
    ShowMessage('The document is empty!');
    Required(lbDocument);
    dbeDocument.SetFocus;
    Exit;
  end;
  ...
  // StateR
  if (Trim(JustNumbers(dbeStateR.Text)) = '') then
  begin
  ...
  // Postal Code
  if (Trim(JustNumbers(dbePostal.Text)) = '') then
  begin
  ...
  begin
    ShowMessage('The neighborhood is empty!');
    Required(lbNeight);
    dbeNeight.SetFocus;
    Exit;
  end;
  ...
  // Number
  if (Trim(JustNumbers(dbeNumber.Text)) = '') then
  begin
    ShowMessage('The number is empty!');
    Required(lbNumber);
    dbeNumber.SetFocus;
    Exit;
  end;
